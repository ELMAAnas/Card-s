...
import { CreateTokenOption, DecodeTokenOption, JwtToken, TokenOption } from './jwt-token';
...
export declare class RefreshToken<T> extends JwtToken<T> {
    ...
    refreshRefreshTokenIfPossible(CreaterefreshTokenOption: CreateRefreshTokenOption<T>): boolean;
}
